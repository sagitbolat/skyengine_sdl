...
pushd %1\build_win
g++ OpenGL_renderer2D.o OpenAL_sound.o sky_ui_imgui.o ..\%2.cpp -IC:\SDL2\include -IC:\glew\include -IC:\glm -IC:\OpenAL_SDK\include -LC:\SDL2\lib -LC:\glew\lib -LC:\OpenAL_SDK\libs\Win64 -Wall -lmingw32 -lSDL2main -lSDL2 -lglew32 -lopengl32 -lOpenAL32 -o %2.exe 
.\%2.exe
popd
